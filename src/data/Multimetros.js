...
const Multimetros = [
    ...
    },
    {
        ...
        Capacitancia: 10000, // En MicroFaradios
    ...
    },
    {
        ...
        Medicion: [VAC, VDC, CDC, CAC, R, C, DIODO, CONTINUIDAD],
        Aplicacion: ELECTRONICA,
        Botones: {
    ...
    },
    {
        ...
        CorrienteAC: 10,
        Resistencia: 40, //En MegaOhmios
        Capacitancia: 40000, // En MicroFaradios
    ...
    },
    {
        ...
        Medicion: [VAC, VDC, CDC, CAC, R, DUTY, F, T, DIODO, CONTINUIDAD, hFE, AUTO, RMS, VFC, RPM],
        Aplicacion: MOTOR,
        Botones: {
    ...
    },
    {
        ...
        Capacitancia: 100000, // En MicroFaradios
        Frecuencia: 10000, //Khz
        Temperatura: { min: -40, max: 1000 },
        Cuentas: 6000,
        Seguridad: 3,
        ImagenSrc: 'https://meters.uni-trend.com/storage/2022/07/UT107_1.jpg',
        Medicion: [VAC, VDC, CDC, CAC, R, C, F, T, DUTY, DIODO, CONTINUIDAD, hFE, AUTO, RMS, VFC, RPM, TESTB],
        Aplicacion: MOTOR,
        Botones: {
            PDF: {src:'https://drive.google.com/file/d/1ZV-FtIaDLiMb8yz60gVcFCsprZ8cfpyt/view', title: PDF},
    ...
    },
    {
        ...
        Medicion: [VAC, VDC, CDC, CAC, R, C, F, T, DUTY, NCV, DIODO, CONTINUIDAD, hFE, RMS, VFC, LIVE],
    ...
    },
    {
        ...
        CorrienteAC: 20,
        Resistencia: 60, //En MegaOhmios
        Capacitancia: 60000, // En MicroFaradios
        Frecuencia: 1000, //Khz
    ...
    },
    {
        ...
        Medicion: [VAC, VDC, CDC, CAC, R, C, F, NCV, DUTY, AUTO, DIODO, CONTINUIDAD, RMS, ANALOGBAR, USB],
        Aplicacion: ELECTRONICA,
        Botones: {
